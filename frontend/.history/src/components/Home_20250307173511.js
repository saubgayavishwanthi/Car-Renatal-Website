...
function Home() {
  ...
  <h1 className="home-heading">Why We Special</h1>
  <div className="row Home-row">
    {images.map((image, index) => (
      <div key={index} className="col-md-4 mb-4 home-image">
        <div className="position-relative text-center">
          <img
            src={image.src}
            alt={image.title}
            className="img-fluid w-70 home-img"
            style={{ width: '70%' }}
          />
...
<div className="home-container my-5">
  ...
  <div className="row Home-row">
    {testimonials.map((testimonial, index) => (
      <div key={index} className="col-md-6 col-lg-4 mb-4 home-feedback">
        <div className="card p-3 shadow border-0 text-center">
          <img
            src={testimonial.image}
            alt={testimonial.name}
            className="rounded-circle mx-auto mb-3 home-feedback-img"
          />
