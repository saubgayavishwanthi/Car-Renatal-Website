...
function RentCar() {
  ...
  useEffect(() => {
    console.log(selectedCategory); // Log selected category to verify
    axios
      .get(`http://localhost:8081/vehicle/filter?vehiclecategory=${selectedCategory}`)
      .then((response) => {
    ...
    <div>
      ...
      <div className="button-grid d-grid d-md-flex gap-2 justify-content-md-center my-3">
        <button
          ...
          onClick={() => setSelectedCategory("rentcar")}
        >
          Rent A Car
        </button>
        <button
              ...
              <div key={index} className="col-md-4">
                <div className="card mb-4 shadow-sm">
                  ...
                  <div className="card-body">
                    ...
                    <button type="button" class="btn btn-dark w-50" onClick={handleReserveClick}>Reserve</button>
                    </div>
                  </div>
